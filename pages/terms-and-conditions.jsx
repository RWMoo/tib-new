...
const Terms = () => {
    return(
       <Layout>
           <Head>
               <title>Territory Insurance Brokers - Terms & Conditions</title>
               <meta name="description" content="Territory Insurance Broker - Terms & Conditions" />
           </Head>
           <div className={"prose-sm md:prose lg:prose-lg xl:prose-xl max-w-none md:max-w-none lg:max-w-none xl:max-w-none mt-16 xl:mt-32"}>
               <div data-custom-class="body">
                   <div>
                       <div>
                           ...
                           <div data-custom-class="heading_1" className={"my-8"}>
                       ...
                       <div>
                           <div data-custom-class="body_text">
                               These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&ldquo;you&rdquo;) and Territory Insurance Brokers (&quot;
                               <strong>
                                   Company
                               </strong>
                               ,&quot; &ldquo;
                               ...
                               <Link  href="/terms-and-conditions">
                                   <a className={"font-bold"}>
                                       https://territoryinsurancebrokers.com.au/terms-and-conditions
                                   </a>
                               </Link>
                               {" "}website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the &ldquo;Site&rdquo;). We are registered in Australia and have our registered office at Level 4/9 Cavenagh St , Darwin , Northern Territory 0800 . You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
                           </div>
                       </div>
                       <div>
                           <div data-custom-class="body_text">
                       ...
                       <div>
                           ...
                           <div>
                               <div>
                                   ...
                                   <div data-custom-class="body_text">
                                       17 . Copy or adapt the Site&rsquo;s software, including but not limited to Flash, PHP, HTML, JavaScript, or other code.
                                   </div>
                                   <div data-custom-class="body_text">
               ...
               <div>
                   ...
                   <div data-custom-class="body_text">
                       These Terms shall be governed by and defined following the laws of Australia . Territory Insurance Brokers and yourself irrevocably consent that the courts of Australia shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.
                   </div>
                   <div data-custom-class="heading_1" className={"my-8"}>
               ...
               <div>
                   <div data-custom-class="heading_2" className={"my-4"}>
               ...
               <div>
                   <div data-custom-class="body_text">
                       <strong>
                           Territory Insurance Brokers
                       </strong>
                   </div>
                   <div data-custom-class="body_text">
                       <strong>
                           Level 4/9 Cavenagh St
                       </strong>
                   </div>
                   <div data-custom-class="body_text">
                       <strong>
                   ...
                   <div data-custom-class="body_text">
                       <strong>
                           enquires@territoryinsurancebrokers.com.au
                       </strong>
                   </div>
               </div>
           </div>
